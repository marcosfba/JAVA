...
public class Pessoa implements Serializable {
	...
	@Colunas(nome = "Endereço da Pessoa", size = 275)
	...
	public Pessoa(String nome, String email, LocalDate dtNascimento, Endereco endereco) {
		super();
		this.nome = nome;
		this.email = email;
	...
	public String toString() {
		return "Pessoa [id=" + id + ", nome=" + nome + ", email=" + email
				+ ", dtNascimento=" + dtNascimento + ", idade=" + getIdade()
				+ ", endereco=" + endereco + "]";
	}
