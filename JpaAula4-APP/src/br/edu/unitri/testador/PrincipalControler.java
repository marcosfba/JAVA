...
public class PrincipalControler implements Initializable {
	...
	@FXML private MenuItem menuItemPessoaEnderecoClick;
	@FXML private MenuItem menuItemPessoaContatosClick;
	...
	@FXML
	void menuItemPessoaEnderecoClick(ActionEvent event) {
		Stage telaPessoaEndereco = new Stage();
		try {
			new FormFX<PessoaEnderecoFX>("PessoaEndereco.fxml", telaPessoaEndereco, "Endereços da Pessoa", false);
		} catch (Exception e) {
			new FXDialog(Type.ERROR, e.getCause().getMessage()).showDialog();
		}
	}
	...
	@FXML
	void menuItemPessoaContatosClick(ActionEvent event) {
		Stage telaPessoaContato = new Stage();
		try {
			new FormFX<PessoaContatoFX>("PessoaContato.fxml", telaPessoaContato, "Contatos da Pessoa", false);
		} catch (Exception e) {
			new FXDialog(Type.ERROR, e.getCause().getMessage()).showDialog();
		}
	}
