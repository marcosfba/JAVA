...
public class ConsultaHFX implements Initializable {
	...
	void btnBuscarClick(ActionEvent event) throws SQLException {
	   	if (isValidConsulta()) {	
			String qry = "select e.nomeempregado, d.desclocal, g.dtemp"
			...
			dados.addAll(exerciciosCtr.findLetraH(qry,where));
	...
	private boolean isValidConsulta() {
		boolean ok = rbEmpregado.isSelected() || rbNomeDep.isSelected();
		if (ok) {
